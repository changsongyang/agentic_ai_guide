...
2024 年以后，推理能力开始从“提示词技巧”逐步变成独立的模型产品能力。以 OpenAI 的 o1 系列（首发于 2024 年 9 月）、后续更高预算的推理产品线，以及 Anthropic 在 Claude 4.x 中提供的 Extended / Adaptive Thinking 为代表，行业趋势变成了：把更多 **测试时计算（test-time compute）** 暴露为可调参数或模式，而不是完全依赖单次前向生成。
...
| **独立推理产品线** | o1 / o3 一类“推理优先”模型 | 多步推理、自检和回溯通常更强 | 延迟更高，不适合所有交互节点 | 数学、规划、故障定位、复杂策略推演 |
