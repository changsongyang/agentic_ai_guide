...
1. 在项目根目录创建项目说明文件。可直接使用 [agentrc](https://github.com/yeasy/agentrc) 提供的最佳实践模板：`curl -fsSL https://raw.githubusercontent.com/yeasy/agentrc/main/AGENTS.md -o AGENTS.md`
2. 根据项目实际情况调整内容
3. 优先补全 **Build / Test / Lint / Permissions**，再补充 **Code Style** 与 **Security**
