...
| 评估维度 | 向量检索 (Vector RAG) | 图记忆 (Graph Memory) | 建议选择 |
|---------|---------------------|---------------------|---------|
| 语义相似搜索 | ★★★★★ | ★★★ | 向量 |
| 多跳关系推理 | ★★ | ★★★★★ | 图 |
| 时序事件追溯 | ★★ | ★★★★ | 图 |
...
> 在实际系统中，两者往往不是非此即彼的选择。混合架构（向量检索做初筛 + 图查询做精确推理）正在成为主流做法。
...
graph_memory = GraphMemory(
    ...
    extractor=EntityRelationExtractor(model="claude-3-5-sonnet-20241022")
)
