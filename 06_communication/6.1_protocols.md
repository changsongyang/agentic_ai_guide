...
随着智能体系统的增删与迭代，通信数据结构也会不可避免地发生演进。如果在没有任何控制的情况下随意修改 Schema，系统中旧版本的智能体会因为无法解析新格式而瞬间崩溃。
...
graph TB
    ...
    BB --> Data1["research_findings"]
    BB --> Data2["current_draft"]
    BB --> Data3["feedback_queue"]
    BB --> Data4["task_status"]
